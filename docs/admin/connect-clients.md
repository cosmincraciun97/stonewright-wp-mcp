...
```json
{
  "mcpServers": {
    "stonewright": {
      "command": "npx",
      "args": ["-y", "https://github.com/cosmincraciun97/stonewright-wp-mcp/releases/download/v1.0.0-alpha.30/stonewright-companion-1.0.0-alpha.30.tgz"],
      "env": {
...
claude mcp add stonewright \
  ...
  -- npx -y https://github.com/cosmincraciun97/stonewright-wp-mcp/releases/download/v1.0.0-alpha.30/stonewright-companion-1.0.0-alpha.30.tgz
```
