...
|---|---|---|---|---|---|---|
| `elementor/elementor` `modules/global-classes/global-classes-rest-api/manage-default-styles-ability.php` | `3afafe33b7499b4e8fcb4c684e55111721bb0c96` | Provider Router contract fixture and certification checks | Behavioral reference; public schema semantics only, no implementation copied | GPL-3.0-or-later | Records the upstream update/delete contract, responsive CSS and pseudo-state descriptions, actual annotations, and runtime `MAX_BATCH_SIZE` of 20; Stonewright keeps upstream writes disabled | `plugin/tests/Unit/Elementor/Provider/ProviderRouterTest.php`; authentic and incompatible contract fixtures; ownership, trust, and complete safety-closure checks |
