...
$lines[] = '';
$lines[] = 'Certification requires active Elementor ownership; exact input/output object schemas and required fields; update/delete, tag, raw CSS, responsive, pseudo-state, patch/replace, and null semantics; `readonly=false`, `destructive=true`, `idempotent=false`; `CLASS_TYPE=class`; and a runtime operation limit no greater than 20.';
$lines[] = '';
$lines[] = '---';
$lines[] = '';
$lines[] = '## Summary';
