...
final class ComposerPolicyTest extends TestCase {
	...
	public function test_root_dev_autoload_cannot_leak_into_production_manifests(): void {
		...
		self::assertArrayNotHasKey(
			'autoload-dev',
			$composer,
			'Jetpack Autoloader merges root dev autoload metadata while optimizing; the test harness must own test namespace loading instead.'
		);
	}
