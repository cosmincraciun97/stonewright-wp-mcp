...
final class UpdateVariable extends AbilityKernel {
 ...
 return __( 'Updates a variable through Elementor Variables_Service and verifies readback.', 'stonewright' ); }
	public function category(): string {
 return 'elementor'; }
	public function meta(): array {
 return [ 'experimental' => true ]; }
	public function input_schema(): array {
 return [ 'type' => 'object', 'additionalProperties' => false, 'required' => [ 'id', 'value' ], 'properties' => [ 'id' => [ 'type' => 'string', 'minLength' => 1 ], 'label' => [ 'type' => 'string', 'minLength' => 1 ], 'type' => [ 'type' => 'string', 'enum' => [ 'global-color-variable', 'global-font-variable', 'global-size-variable', 'global-custom-size-variable' ] ], 'value' => [] ] ]; }
...
return $adapter; }
			...
			if ( isset( $args['label'] ) ) {
$payload['label'] = (string) $args['label']; }
			if ( isset( $args['type'] ) ) {
