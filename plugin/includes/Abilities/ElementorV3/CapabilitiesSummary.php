...
final class CapabilitiesSummary extends AbilityKernel {
	...
	public function output_schema(): array {
		return [
			...
			'properties' => [
				...
				'css_regenerate_tool'            => [ 'type' => 'string' ],
				'post_write_verification_tool'   => [ 'type' => 'string' ],
	...
	public function execute( array $args ): array|\WP_Error {
		...
		return [
			...
			'post_write_verification_tool'   => 'stonewright/elementor-post-write-verify',
			...
			'first_pass_rules'    => [
				...
				'For every widget used, call stonewright/elementor-schema with mode=summary before writing settings; request mode=control for one complete control or paginated mode=full only when required.',
				...
				'After any Elementor write, call stonewright/elementor-css-regenerate when generated CSS must be rebuilt, then stonewright/elementor-post-write-verify with touched element ids before desktop, tablet, and mobile browser acceptance.',
