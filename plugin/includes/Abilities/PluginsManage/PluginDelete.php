...
final class PluginDelete extends AbilityKernel {
 ...
 return [ 'additionalProperties' => true, 'type'=>'object', 'properties'=>[ 'deleted'=>[ 'type'=>'boolean' ], 'plugin'=>[ 'type'=>'string' ] ], 'required'=>[ 'deleted', 'plugin' ] ]; }
...
return $result;
			...
			return [ 'deleted'=>true,'plugin'=>$plugin ];
		});
	}
}
