	...
	public static function blueprint_prompt( array $bp ): string {
		...
		$lines = array_merge(
			...
			[
				...
				'4. Call stonewright/blueprint-apply with id="' . $id . '" targeting a draft page unless the user named an existing post_id. If Elementor is unavailable the apply falls back to Gutenberg automatically — do not hand-build with php-execute.',
				...
				'8. Finish with a visual QA pass (desktop + mobile) and report the page URL + post_id + qa score.',
				'',
				'## Constraints',
