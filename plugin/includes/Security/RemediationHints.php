...
final class RemediationHints {
	...
	private const CODE_HINTS = [
		...
		'stonewright_custom_code_grant_invalid'      => 'The custom-code grant is malformed, expired, already used, or bound to a different candidate. Rerun dry_run, issue a fresh one-time grant from the returned approval URL, copy the complete token, and retry the unchanged candidate once.',
