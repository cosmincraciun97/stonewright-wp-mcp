...
final class AgentInstructions {
	...
	public static function default( bool $include_visual = true ): string {
		$parts = [
			...
			'- Elementor CSS safety: CSS mutation belongs only to stonewright-elementor-css-regenerate, which snapshots the post then calls Elementor update_file inside a guarded asset transaction. Never pass regenerate_css to stonewright-elementor-post-write-verify; that ability is observation-only and does not regenerate CSS, invalidate caches, or roll back files.',
