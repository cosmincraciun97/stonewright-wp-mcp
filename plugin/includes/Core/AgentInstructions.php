...
final class AgentInstructions {
	...
	public static function server_bootstrap_summary(): string {
		$parts = [
			...
			'- Design/Elementor: read stonewright-design-direction-brief once, normalize DesignEvidence, run stonewright-design-native-plan, review approved kit globals, then compile live-schema writes in small verified batches.',
	...
	public static function default( bool $include_visual = true ): string {
		$parts = [
			...
			'- For comment moderation, user management, application passwords, widgets, allowlisted settings, theme activation, plugin lifecycle, revision restore, granular site-health tests, search/oEmbed, and WooCommerce reads, use the dedicated stonewright abilities (site-admin / content-model profiles) instead of raw REST or shell workarounds.',
