...
final class AgentInstructions {
	...
	public static function default( bool $include_visual = true ): string {
		$parts = [
			...
			'- Never guess WordPress/Elementor/Gutenberg schemas — read first, research official docs when unknown, verify after writes. Fix recurring_errors from task-start before new work.',
