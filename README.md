...
<p align="center">
  <img src="assets/screenshots/stonewright-dashboard-beta10.svg" alt="Stonewright dashboard with the current admin navigation and a verified Plugin-mode connection" width="1200" />
</p>
...
| Elementor (local WP-CLI) | **status / data-get / data-update** | Mandatory file backup; preserve CSS metadata, run no CSS flush, and require Plugin-mode guarded CSS closure |
